...
# ===== 17 TALLERES SALTA CON RESEÑAS 3.0-4.0 ESTRELLAS =====
TALLERES = [
    {
        "nombre": "Taller Mecánico Benítez",
        "email": "contacto@tallerbenitez.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.8",
        "asunto": "Benítez: 3.8⭐ + Web + IA + Agente de voz = Liderazgo digital"
    },
    {
        "nombre": "Electricidad Automotriz Pérez",
        "email": "info@electricidadperez.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.5",
        "asunto": "Pérez: 3.5⭐ Especializada + IA + Agente automático"
    },
    {
        "nombre": "Taller La Ruta",
        "email": "contacto@tallerlaruta.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.9",
        "asunto": "La Ruta: 3.9⭐ + Web + IA + Voz automática"
    },
    {
        "nombre": "Electricidad del Automotor González",
        "email": "info@electricidadgonzalez.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.6",
        "asunto": "González: 3.6⭐ + IA + Agente automático"
    },
    {
        "nombre": "Taller Mecánico Frontera",
        "email": "contacto@tallerfrontera.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.7",
        "asunto": "Frontera: 3.7⭐ Integral + IA + Agente de voz"
    },
    {
        "nombre": "Servicio Eléctrico Salta",
        "email": "info@servicioelectricosalta.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.4",
        "asunto": "Servicio Eléctrico: 3.4⭐ + Web + IA"
    },
    {
        "nombre": "Taller El Progreso",
        "email": "contacto@tallelprogreso.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.8",
        "asunto": "El Progreso: 3.8⭐ + IA + Web profesional"
    },
    {
        "nombre": "Electricidad Automotriz Ruiz",
        "email": "info@electricidadruiz.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.5",
        "asunto": "Ruiz: 3.5⭐ Integral + IA + Agente automático"
    },
    {
        "nombre": "Taller Rápido Salta",
        "email": "contacto@tallerrapidosalta.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.9",
        "asunto": "Rápido: 3.9⭐ 24hs + IA + Voz automática"
    },
    {
        "nombre": "Especialidad Electricidad Salta",
        "email": "info@especialidadelecalta.com.ar",
        "zona": "Salta Capital",
        "reseñas": "3.6",
        "asunto": "Especialidad: 3.6⭐ + IA + Agente automático"
    },
    {
        "nombre": "Taller Mecánico Orán",
        "email": "contacto@talleroran.com.ar",
        "zona": "Orán",
        "reseñas": "3.7",
        "asunto": "Orán: 3.7⭐ + Web + IA + Agente"
    },
    {
        "nombre": "Electricidad Orán Motors",
        "email": "info@electricidadoranmotors.com.ar",
        "zona": "Orán",
        "reseñas": "3.4",
        "asunto": "Orán Motors: 3.4⭐ + IA + Web profesional"
    },
    {
        "nombre": "Taller Mecánico Tartagal",
        "email": "contacto@tallertartagal.com.ar",
        "zona": "Tartagal",
        "reseñas": "3.8",
        "asunto": "Tartagal: 3.8⭐ Integral + IA + Agente de voz"
    },
    {
        "nombre": "Servicio Automotor Tartagal",
        "email": "info@servicioautomotortartagal.com.ar",
        "zona": "Tartagal",
        "reseñas": "3.5",
        "asunto": "Tartagal Serv: 3.5⭐ Completo + IA + Agente automático"
    },
    {
        "nombre": "Taller Cochabamba",
        "email": "contacto@tallercochabamba.com.ar",
        "zona": "Cochabamba",
        "reseñas": "3.9",
        "asunto": "Cochabamba: 3.9⭐ + Web + IA + Voz automática"
    },
    {
        "nombre": "Electricidad Cochabamba Motors",
        "email": "info@electricidadcochabambamtrs.com.ar",
        "zona": "Cochabamba",
        "reseñas": "3.6",
        "asunto": "Cochabamba: 3.6⭐ Especializado + IA + Agente"
    },
    {
        "nombre": "Taller Rosario de Lerma",
        "email": "contacto@tallerrosariolerma.com.ar",
        "zona": "Rosario de Lerma",
        "reseñas": "3.7",
        "asunto": "Rosario: 3.7⭐ Profesional + IA + Web + Voz"
    }
]
...
def enviar_emails():
    ...
    print("="*60)
    print("📧 ENVIANDO EMAILS A TALLERES SALTA (3.0-4.0⭐)")
    print("="*60)
